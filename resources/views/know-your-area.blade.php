...
<section class="about-us abt-ward">
    <div class="container-fluid">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <h3>अपना कॉलोनी नाम दर्ज करें :</h3>
                    <table class="table table-bordered text-center">
                        <thead>
                        <tr>
                            <th class="text-center">कॉलोनी का नाम :</th>
                    ...
                    <div class="ward-dtl">
                        <table class="table table-bordered text-center" id="exampl">
                            <thead>
                            <tr>
                                <th class="text-center">जोन संख्या</th>
                                <th class="text-center">जोन का नाम</th>
                                <th class="text-center">वार्ड नं</th>
                                <th class="text-center">वार्ड का नाम</th>
                                <th class="text-center">कालोनी</th>
                                <th class="text-center">कॉलोनी श्रेणी</th>
                            </tr>
                            </thead>
                            <tbody id="colony_html">
                            <tr>
                                <td colspan="6">कोई आकड़ा उपलब्ध नहीं है</td>
                            </tr>
                            </tbody>
                        </table>
                        {{--<div class="abt-ward-info">--}}
                            {{--<strong class="listStrong">दिल्ली नगर निगम में विभाजित है :</strong>--}}
                            {{--<ul>--}}
                                {{--<li>उत्तरी दिल्ली नगर निगम</li>--}}
                                {{--<li>दक्षिणी दिल्ली नगर निगम</li>--}}
                                {{--<li>पूर्वी दिल्ली नगर निगम</li>--}}
                            {{--</ul>--}}
    ...
    <!--width: 603px;height: 570px;"></iframe></div>-->
                    <div id="map-container" style="height:611px;"></div>
             </div>
                </div>
            </div>
        </div>
