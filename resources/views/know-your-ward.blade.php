...
@section('content')
        ...
        <div class="container-fluid">
            <div class="container">
                <div class="row text-center">
                    <div class="col-sm-12">
                        <h2 class="cmn-h2">अपने वार्ड को जानें</h2>
                    </div>
                </div>
                <div class="row">
                    <!--<div class="col-sm-6">-->
    ...
    border-color: #925f6e;">मानचित्र विवरण के लिए क्लिक करें</button>
		</div>
    ...
    $(".collapse").slideToggle();
            ...
            <div id="menu" class="collapse">
			  ...
			  <tr>
					...
					<td style="font-size: 16px;padding: 3px 0px 0px 6px;">CRPark निर्मितp : </td>
    ...
    $(".collapse").slideToggle();
            ...
            <div id="menus" class="collapse">
			  ...
			  <tr>
					...
					<td style="font-size: 16px;padding: 10px 0px 0px 0px;">उद्योग : </td><td>
					...
					<td style="font-size: 16px;padding: 10px 0px 0px 0px;">स्कूलों: </td><td>
