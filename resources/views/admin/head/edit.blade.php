...
@section('content')
    <h3 class="page-title">Edit Head</h3>
    
    {!! Form::model($category, ['method' => 'PUT', 'route' => ['admin.head.update', $category->id],'enctype'=>'multipart/form-data']) !!}

    {!! Form::open(['method' => 'POST', 'route' => ['admin.head.store'],'enctype'=>'multipart/form-data']) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    <label class="col-md-2 control-label"> Head Name</label>
                    <div class="col-md-7">
