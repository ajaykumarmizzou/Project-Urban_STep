...
@section('content')
    <h3 class="page-title">Edit Update Us Master</h3>

    {!! Form::model($subcategory, ['method' => 'PUT', 'route' => ['admin.updateusmaster.update', $subcategory->id],'enctype'=>'multipart/form-data']) !!}

    {!! Form::open(['method' => 'POST', 'route' => ['admin.updateusmaster.store']]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    <label class="col-md-2 control-label">Update Name</label>
                    <div class="col-md-7">
...
<script>
    $('#cat_id').on('change',function (){
        ...
        $.ajax({
            type : 'POST',
            url : '{{url('admin/updateusmasters/subcategory')}}',
