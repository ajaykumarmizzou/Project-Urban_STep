...
@section('content')
    <h3 class="page-title">Ongoing Project</h3>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <div class="col-md-7">
                        <input type="text" name="name" id="name" value="" class="form-control" placeholder="Enter Project title" required>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <div class="col-md-7">
                        <textarea type="text" name="description" id="description" value="" class="form-control" placeholder="Enter Description" required></textarea>
                        <?php //echo form_error('name'); ?>
                    </div>
                </div>
            </div>
