        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <div class="col-md-7">
                        {!! Form::select('location', $area, old('location'), ['class' => 'form-control ', 'required' => '', 'data-placeholder' => 'Select area']) !!}
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <div class="col-md-7">
                        <input id="area" name="area" class="form-control" type="text" placeholder="Ward" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <div class="col-md-7">
                        <input id="ward_number" name="ward_number" class="form-control" type="text" placeholder="Ward Number" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <div class="col-md-7">
                        <input id="color" name="color" class="form-control" value="" type="text" placeholder="Ward Color" >
                    </div>
                </div>
            </div>
            <div class="row">
