...
@section('content')
    <h3 class="page-title">Edit SubMenu</h3>
    
    {!! Form::model($subcategory, ['method' => 'PUT', 'route' => ['admin.submenu.update', $subcategory->id],'enctype'=>'multipart/form-data']) !!}

    {!! Form::open(['method' => 'POST', 'route' => ['admin.submenu.store']]) !!}
