                ...
                <div class="dashboard-main-wrapper"> 
                    <div class="dashboard-navigation">
                        ...
                        <ul class="dashboard-menu">
                            ...
                            <li>
                                <a class="nav-link active" href="{{url('/my-update')}}"><i class="fa fa-file"></i>अतीत  अपडेट</a>
                            </li>
                            <li>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header">
                                    <h2 class="pageheader-title">हमें अपडेट करें</h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                        ...
                                        <table id="myTable" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($results as $user)
                                                    <?php
                                                    $up= \App\UpdateUsMaster::where('id',$user->updateus_id)->first();
                                                    ...
                                                    <tr data-entry-id="{{ $user->id }}">
                                                        ...
                                                        <td field-key='name'>@if($up){{ $up->name }}@endif</td>
                                                        <td><?php if($user->myfile){?><a href="{{ url('public/uploads/complain/'.$user->myfile) }}" target="_blank">View</a><?php }?></td>
